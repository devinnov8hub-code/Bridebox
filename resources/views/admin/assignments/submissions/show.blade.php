...
@section('main')
    <main class="main">
        <header class="topbar">
            ...
            <div class="actions">
                <a class="btn ghost" href="{{ route('admin.assignments.submissions.index', $assignment) }}">{{ __('Back to Submissions') }}</a>
                @if ($submission->file_path)
                    <a class="btn ghost" href="{{ route('admin.assignments.submissions.download', [$assignment, $submission]) }}">{{ __('Download File') }}</a>
                @endif
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-grid" action="{{ route('admin.assignments.submissions.update', [$assignment, $submission]) }}" method="post">
                    @csrf
                    @method('put')
