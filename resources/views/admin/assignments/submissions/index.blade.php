    ...
    <main class="main">
        <header class="topbar">
            <div class="greeting">
                ...
                <p class="subtext">{{ __('Lesson') }}: {{ $assignment->lesson?->title ?? '-' }}</p>
            </div>
            <div class="actions">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="table-actions">
                                            <a class="btn ghost btn-small" href="{{ route('admin.assignments.submissions.show', [$assignment, $submission]) }}">{{ __('Grade') }}</a>
                                            @if ($submission->file_path)
                                                <a class="btn ghost btn-small" href="{{ route('admin.assignments.submissions.download', [$assignment, $submission]) }}">{{ __('Download') }}</a>
                                            @endif
                                            <form method="post" action="{{ route('admin.assignments.submissions.delete', [$assignment, $submission]) }}" data-confirm="{{ __('Delete this submission?') }}" style="display:inline-block;">
                                                @csrf
                                                @method('delete')
