...
@section('title', __('Create Assignment'))
    ...
    <main class="main">
        <header class="topbar">
            <div class="greeting">
                ...
                <h1>{{ __('Create Assignment') }}</h1>
                <p class="subtext">{{ __('Create an assignment based on a lesson.') }}</p>
            </div>
            <div class="actions">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-grid" action="{{ route('admin.assignments.store') }}" method="post">
                    @csrf
                    ...
                    <div class="form-field">
                        ...
                        <select id="lesson_id" name="lesson_id" required data-lessons-url="{{ route('admin.topics.lessons.by-topic') }}" data-selected-lesson="{{ old('lesson_id') }}">
                            <option value="" disabled @selected(!old('lesson_id'))>{{ __('Select a topic first') }}</option>
                        </select>
                        @error('lesson_id')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
