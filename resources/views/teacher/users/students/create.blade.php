    ...
    <main class="main">
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                <form class="form-grid" action="{{ route('teacher.students.store') }}" method="post">
                    @csrf
                    ...
                    <div class="form-field">
                        ...
                        <select id="school_class_id" name="school_class_id" required>
                            <option value="" disabled @selected(!old('school_class_id', $teacherClassId ?? null))>{{ __('Select a class') }}</option>
                            @foreach ($classes as $class)
                                <option value="{{ $class->id }}" @selected(old('school_class_id', $teacherClassId ?? null) == $class->id)>{{ $class->name }}</option>
                            @endforeach
                        </select>
