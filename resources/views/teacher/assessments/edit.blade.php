            ...
            <div class="panel-body">
                <form class="form-grid" action="{{ route($routePrefix . '.update', $assessment) }}" method="post">
                    ...
                    <div class="form-field">
                        ...
                        <select id="subject_id" name="subject_id" required data-subjects-url="{{ route('teacher.subjects.by-class') }}" data-selected-subject="{{ old('subject_id', $assessment->subject_id) }}">
                    ...
                    <div class="form-field form-field-full">
                        ...
                        <textarea id="description" name="description" required data-wysiwyg>{{ old('description', $assessment->description) }}</textarea>
                        @error('description')
                            <span class="form-error">{{ $message }}</span>
                        @enderror
                    </div>
